...
//1 nav
    ...
    if (scrollTop >= toVideos-80 && scrollTop < toDocuments-80) {
        ...
        $(".navWeb .nav li").css("border", "none");
        $(".navWeb .nav li:contains('Tools & document')").css("border-bottom", "solid 5px #1B365D");
...
//3 nav clickTo
    ...
    //web clickTo
    $(".nav li:contains('Videos')").click(function () {
        $('html,body').animate({scrollTop: toVideos-80}, 400);
        //window.scrollTo(0,$(".videos").offset().top);
        return false
    })
    $(".nav li:contains('Tools & documents')").click(function () {
        $('html,body').animate({scrollTop: toDocuments-80}, 400);
        //window.scrollTo(0,$(".documents").offset().top);
        return false
    })
    $(".nav li:contains('Other products')").click(function () {
        $('html,body').animate({scrollTop: toProducts-80}, 400);
        //window.scrollTo(0,$(".products").offset().top);
        return false
    })
    //mobil clickTo
